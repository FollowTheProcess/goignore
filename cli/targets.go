...
// Alphabetically sorted list of gitignore.io targets
// the order is important and must be maintained because it lets us do a binary search to quickly determine
// if a target is in here without needing to iterate through the whole thing
// in other words, the sort makes it O(log n) rather than O(n)
//
